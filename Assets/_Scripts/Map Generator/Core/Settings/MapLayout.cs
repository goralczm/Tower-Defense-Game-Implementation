...
public class MapLayout
{
    ...
    public List<Node> GetNodes() => _mazeByCoords.Values.ToList();
    ...
    public Node GetByCoords(Vector2Int coords)
    {
        if (!_mazeByCoords.TryGetValue((coords.x, coords.y), out Node node))
        {
