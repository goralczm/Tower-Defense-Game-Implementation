...
namespace Towers.Projectiles
{
    public class PermanentContactProjectile : IProjectileMovement
    {
        ...
        public void Move(Vector2 target)
        {
            ...
            var targets = Targeting.Targeting.GetTargetsInRange(_projectile.transform.position, _projectile.transform.localScale.x / 2f, _projectile.CanDamageAlignments);
